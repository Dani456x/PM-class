...
.profile-icon {
  ...
  object-fit: contain;
  display: block;
  /* Prototype-only: tint icons toward maroon for a consistent onboarding set. */
  filter: brightness(0) saturate(100%) invert(13%) sepia(34%) saturate(4142%) hue-rotate(338deg) brightness(88%) contrast(97%);
}
</style>
